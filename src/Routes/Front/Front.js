            ...
            <div className="container-fluid frontContent">
                <div className="row">
                    <div className="col-md-4 offset-md-4 col-8 offset-2">
                        ...
                        <p>
                            Selv har jeg opplevd at det er veldig vanskelig å velge fag på I&IKT, og at <a href="https://www.ntnu.no/studier/mting/oppbygning"  rel="noopener noreferrer" target="_tab" className="frontLink">NTNU sin studieplanlegger</a> ikke nødvendigvis gir de beste fagforslagene for hver spesialisering.
                            Denne appen lar deg sette opp og lagre studieplaner blant et bredt utvalg fag som kan filteres basert på 25 ulike kategorier. Fagene er kateogisert av undertegnede etter beste evne.
                        </p>
                        <br></br>
                        <h5>Noen av tingene du kan gjøre i appen er:</h5>
                        <h6 style={{'marginTop':'15px'}}>1. Registrere bruker, lagre og laste inn fagplaner</h6>
                        <p>Husk å lagre fagplanene dine ved bruk av "Lagre planer"-knappen! Denne dukker opp etter du har lagd bruker og/eller logget inn</p>
                        <h6 style={{'marginTop':'15px'}}>1. Velge spesialisering</h6>
                        ...
                        <h6 style={{'marginTop':'15px'}}>2. Velg semester med utveksling</h6>
                        <p>Gjøres dersom bruker manuelt ønsker å skrive inn navn på utvekslingsfag</p>
                        <h6 style={{'marginTop':'15px'}}>3. Se oppsummering av valgte fag i grafen/menyen</h6>
                        ...
                        <h6 style={{'marginTop':'15px'}}>4. Se anbefalte fag utfra kateogi</h6>
                        ...
                        <h6 style={{'marginTop':'15px'}}>5. Velg fag</h6>
                        <h6 style={{'marginTop':'15px'}}>5.1 Filtrer på kategori</h6>
                        ...
                        <h6 style={{'marginTop':'15px'}}>5.2 Filtrer på fritekst</h6>
                        ...
                        <h6 style={{'marginTop':'15px'}}>5.3 Legg til fag i fagplanen</h6>
